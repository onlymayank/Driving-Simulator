...
from directkeys import PressKey, A, D, Space,W, ReleaseKey
...
while True:
    ...
    colourLower = np.array([79, 133, 203])
    ...
    img = cv2.rectangle(img,(0,0),(width//3 - 35,height//2 ),(0,255,0),1)
    cv2.putText(img,'LEFT',(110,30),cv2.FONT_HERSHEY_DUPLEX,1,(139,0,0))

    img = cv2.rectangle(img,(width//2 + 100,0),(width-2,height//2 ),(0,255,0),1)
    ...
    cv2.putText(img,'NITRO',(2*(width//4) + 20,height-10),cv2.FONT_HERSHEY_DUPLEX,1,(139,0,0))
